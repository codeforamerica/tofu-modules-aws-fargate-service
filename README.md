...
The AppConfig Agent sidecar does not reserve dedicated CPU or memory. When
enabled, it shares the task's remaining resources with your application. The
agent is lightweight and consumes minimal resources under normal operation.
